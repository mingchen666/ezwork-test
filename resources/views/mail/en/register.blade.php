...
<html>
  ...
  <body>
    ...
    <p>You are requesting a verification code registration platform , the verification code is valid for {{$user['expired']}}, please use it as soon as possible. Please ignore this email if you are not doing it yourself.</p>
    <p>
